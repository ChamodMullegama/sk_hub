                                ...
                                <div class="productCard_leftSide clearfix">
                                    <div class="productCard_brendBlock">
                                        <a class="productCard_brendBlock__imageBlock" href="#">
                                            <img src="../Copy of Black White Minimalist Aesthetic Letter Initial Name Monogram Logo (1).png" alt="" height="50px" width="60px">
                                        </a>
                                    </div>
                                        ...
                                        <div class="block_informationAboutDevice">
                                            ...
                                            <div class="row ">
                                                ...
                                                <div class="large-6 small-12 column end">
                                                    <div class="block_goodSize"> <!-- Assuming you have a block for sizes -->
                                                        <span class="text_specification">Choose your size:</span>
                                                        <div class="block_goodSize__allSizes"> <!-- Assuming you have a block for all size options -->
                                                            <input type="radio" name="sizeOfItem" class="radio_button" id="radioSizeS" checked/>
                                                            <label for="radioSizeS" class="block_goodSize__radio">S</label>
                                                            
                                                            <input type="radio" name="sizeOfItem" class="radio_button" id="radioSizeM"/>
                                                            <label for="radioSizeM" class="block_goodSize__radio">M</label>
                                                            
                                                            <input type="radio" name="sizeOfItem" class="radio_button" id="radioSizeL"/>
                                                            <label for="radioSizeL" class="block_goodSize__radio">L</label>
                                                            
                                                            <input type="radio" name="sizeOfItem" class="radio_button" id="radioSizeXL"/>
                                                            <label for="radioSizeXL" class="block_goodSize__radio">XL</label>
                                                            
                                                            <input type="radio" name="sizeOfItem" class="radio_button" id="radioSizeXXL"/>
                                                            <label for="radioSizeXXL" class="block_goodSize__radio">XXL</label>
                                                        </div>
                                                    </div>
                                                </div>
...
<a href="https://codepen.io/BlackStar1991/pens/public/" target="_new">
    <i class='fa fa-codepen'></i> my other Pens</a>
        ...
        <div class="container">
            ...
            <p>Sub-Category: <?php echo $item['sub_category']; ?></p>
            <p>Brand: <?php echo $item['brand']; ?></p>
            <p>Gender: <?php echo $item['gender']; ?></p>
            <p>Size Options: <?php echo $item['sizeOptions']; ?></p>
            <p>Material: <?php echo $item['material']; ?></p>
            <p>Quantity Available: <?php echo $item['quantityAvailable']; ?></p>
            <p>Description: <?php echo $item['description']; ?></p>
            <p>Care Instructions: <?php echo $item['careInstructions']; ?></p>
            <p>Tags: <?php echo $item['tags']; ?></p>
            <p>Availability Status: <?php echo $item['availabilityStatus']; ?></p>
            <p>Discounts: <?php echo $item['discounts']; ?></p>
